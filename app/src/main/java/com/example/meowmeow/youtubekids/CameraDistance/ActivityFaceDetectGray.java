package com.example.meowmeow.youtubekids.CameraDistance;
...
public final class ActivityFaceDetectGray extends AppCompatActivity implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_detect_gray);
...
//    }
    ...
    private void setDisplayOrientation() {
        ...
        mDisplayRotation = Utils.getDisplayRotation(ActivityFaceDetectGray.this);
...
//            Log.i("FaceDetectThread", "running");
    ...
    private void SetBackgroundUnscreen() {
        ...
        if(detectThread.eyesDis >= 80 && detectThread.eyesDis <= 160)
        {
            dialog.dismiss();
        }
        else {
    ...
    private void resetData() {
        if (imagePreviewAdapter == null) {
            ...
            imagePreviewAdapter = new ImagePreviewAdapter(ActivityFaceDetectGray.this, facesBitmap, new ImagePreviewAdapter.ViewHolder.OnItemClickListener() {
                @Override
